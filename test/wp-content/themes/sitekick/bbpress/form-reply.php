			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags', bbp_get_topic_id() ) ) : ?>
						...
						<p>
							<label class="form-label" for="bbp_topic_tags"><?php esc_html_e( 'Tags:', 'bbpress' ); ?></label><br />
					...
					<?php if ( bbp_is_reply_edit() ) : ?>
						...
						<?php if ( current_user_can( 'moderate', bbp_get_reply_id() ) ) : ?>
							...
							<p class="form-reply-to">
								<label class="form-label" for="bbp_reply_to"><?php esc_html_e( 'Reply To:', 'bbpress' ); ?></label><br />
							...
							<p>
								<label class="form-label" for="bbp_reply_status"><?php esc_html_e( 'Reply Status:', 'bbpress' ); ?></label><br />
						...
						<?php if ( bbp_allow_revisions() ) : ?>
							...
							<fieldset class="bbp-form">
								<legend>
									...
									<label class="form-label" for="bbp_log_reply_edit"><?php esc_html_e( 'Keep a log of this edit:', 'bbpress' ); ?></label><br />
								</legend>

								<div>
									<label class="form-label" for="bbp_reply_edit_reason"><?php printf( esc_html__( 'Optional reason for editing:', 'bbpress' ), bbp_get_current_user_name() ); ?></label><br />
