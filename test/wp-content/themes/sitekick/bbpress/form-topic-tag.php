		...
		<fieldset class="bbp-form" id="bbp-edit-topic-tag">
			...
			<fieldset class="bbp-form" id="tag-rename">
				...
				<form id="rename_tag" name="rename_tag" method="post">
					...
					<div>
						<label class="form-label" for="tag-name"><?php esc_html_e( 'Name:', 'bbpress' ); ?></label>
					...
					<div>
						<label class="form-label" for="tag-slug"><?php esc_html_e( 'Slug:', 'bbpress' ); ?></label>
					...
					<div>
						<label class="form-label" for="tag-description"><?php esc_html_e( 'Description:', 'bbpress' ); ?></label>
			...
			<fieldset class="bbp-form" id="tag-merge">
				...
				<form id="merge_tag" name="merge_tag" method="post">
					...
					<div>
						<label class="form-label" for="tag-existing-name"><?php esc_html_e( 'Existing tag:', 'bbpress' ); ?></label>
