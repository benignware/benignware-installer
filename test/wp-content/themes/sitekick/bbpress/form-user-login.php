...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
	<fieldset class="bbp-form">
		...
		<div class="bbp-username row mb-1">
		...
		<div class="bbp-password row">
			<div class="col-sm-2 col-form-label">
				<label class="form-label" for="user_pass"><?php esc_html_e( 'Password', 'bbpress' ); ?>: </label>
			</div>
			<div class="col-sm-4">
		...
		<div class="bbp-remember-me form-check mb-3">
			<input class="form-check-input" type="checkbox" name="rememberme" value="forever" <?php checked( bbp_get_sanitize_val( 'rememberme', 'checkbox' ) ); ?> id="rememberme" />
			<label class="form-check-label" for="rememberme">
				<?php esc_html_e( 'Keep me signed in', 'bbpress' ); ?>
			</label>
		</div>
