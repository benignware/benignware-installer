...
?>
<div id="payment" class="woocommerce-checkout-payment my-4">
	...
	<div class="form-row place-order">
		<noscript>
			...
			?>
			<br/><button type="submit" class="button alt btn btn-secondary" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'woocommerce' ); ?>"><?php esc_html_e( 'Update totals', 'woocommerce' ); ?></button>
		</noscript>
