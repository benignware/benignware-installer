...
<div id="password" class="user-pass1-wrap">
	<label class="form-label" for="user_login"><?php esc_html_e( 'Password', 'bbpress' ); ?></label>
...
<div class="user-pass2-wrap hide-if-js">
	<label class="form-label" for="pass2"><?php esc_html_e( 'Repeat New Password', 'bbpress' ); ?></label>
	<input name="pass2" type="password" id="pass2" class="regular-text" value="" autocomplete="off" />
	<p class="description"><?php esc_html_e( 'Type your new password again.', 'bbpress' ); ?></p>
</div>

<div class="pw-weak">
	<label class="form-label" for="pw_weak"><?php esc_html_e( 'Confirm', 'bbpress' ); ?></label>
