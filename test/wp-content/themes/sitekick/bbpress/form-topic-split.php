			...
			<form id="split_topic" name="split_topic" method="post">
				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bbp-template-notice info alert alert-info">
						...
						<fieldset class="bbp-form">
							...
							<div>
								...
								<label class="form-label" for="bbp_topic_split_option_reply"><?php printf( esc_html__( 'New topic in %s titled:', 'bbpress' ), bbp_get_forum_title( bbp_get_topic_forum_id( bbp_get_topic_id() ) ) ); ?></label>
							...
							<?php if ( bbp_has_topics( array( 'show_stickies' => false, 'post_parent' => bbp_get_topic_forum_id( bbp_get_topic_id() ), 'post__not_in' => array( bbp_get_topic_id() ) ) ) ) : ?>
								...
								<div>
									...
									<label class="form-label" for="bbp_topic_split_option_existing"><?php esc_html_e( 'Use an existing topic in this forum:', 'bbpress' ); ?></label>
						...
						<fieldset class="bbp-form">
							...
							<div>
								...
								<?php if ( bbp_is_subscriptions_active() ) : ?>
									...
									<label class="form-label" for="bbp_topic_subscribers"><?php esc_html_e( 'Copy subscribers to the new topic', 'bbpress' ); ?></label><br />

								<?php endif; ?>

								<input name="bbp_topic_favoriters" id="bbp_topic_favoriters" type="checkbox" value="1" checked="checked" />
								<label class="form-label" for="bbp_topic_favoriters"><?php esc_html_e( 'Copy favoriters to the new topic', 'bbpress' ); ?></label><br />

								<?php if ( bbp_allow_topic_tags() ) : ?>

									<input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1" checked="checked" />
									<label class="form-label" for="bbp_topic_tags"><?php esc_html_e( 'Copy topic tags to the new topic', 'bbpress' ); ?></label><br />
						...
						<div class="bbp-template-notice error alert alert-danger" role="alert" tabindex="-1">
							<ul class="list-unstyled m-0">
