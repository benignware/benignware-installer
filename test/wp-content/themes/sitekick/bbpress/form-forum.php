		...
		<form id="new-post" name="new-post" method="post">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<label class="form-label" for="bbp_forum_title"><?php printf( esc_html__( 'Forum Name (Maximum Length: %d):', 'bbpress' ), bbp_get_title_max_length() ); ?></label><br />
					...
					<?php if ( bbp_allow_forum_mods() && current_user_can( 'assign_moderators' ) ) : ?>
						...
						<p>
							<label class="form-label" for="bbp_moderators"><?php esc_html_e( 'Forum Moderators:', 'bbpress' ); ?></label><br />
					...
					<p>
						<label class="form-label" for="bbp_forum_type"><?php esc_html_e( 'Forum Type:', 'bbpress' ); ?></label><br />
					...
					<p>
						<label class="form-label" for="bbp_forum_status"><?php esc_html_e( 'Status:', 'bbpress' ); ?></label><br />
					...
					<p>
						<label class="form-label" for="bbp_forum_visibility"><?php esc_html_e( 'Visibility:', 'bbpress' ); ?></label><br />
					...
					<p>
						<label class="form-label" for="bbp_forum_parent_id"><?php esc_html_e( 'Parent Forum:', 'bbpress' ); ?></label><br />
...
<?php else : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice alert alert-warn">
			<ul class="list-unstyled m-0">
