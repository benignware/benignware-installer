...
<form method="post" class="wc-auth-login">
	<p class="form-row form-row-wide">
		...
		<input type="text" class="input-text form-control" name="username" id="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( $_POST['username'] ) : ''; ?>" /><?php //@codingStandardsIgnoreLine ?>
	</p>
	<p class="form-row form-row-wide">
	...
	<p class="wc-auth-actions">
		...
		<button type="submit" class="button button-large button-primary wc-auth-login-button btn btn-primary" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
